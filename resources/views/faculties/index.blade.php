    ...
    <div class="max-w-4xl mx-auto w-full sm:px-1">
      ...
      <div class="flex justify-end my-2">
        <a href="{{ route('faculties.create') }}"
          class="px-4 py-2 bg-gray-700 hover:bg-gray-800 rounded-lg text-white">Ajouter une faculté</a>
      </div>
                ...
                <tr
                  ...
                  <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="flex space-x-3">
                      <a href="{{ route('faculties.edit', $faculty->sigle) }}"
                        class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white">Edit</a>
                      <form action="{{ route('faculties.destroy', $faculty->sigle) }}" method="post"
